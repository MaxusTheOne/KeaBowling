        ...
        <div id="reservation-page-add-container">
            <form className="form-container" onSubmit={handleSubmit}>
                ...
                <select
                    ...
                    onChange={(e) =>
                        setReservation((prev) => ({ ...prev, userId: Number(e.target.value) }))
                    }
                >
                ...
                <input
                    ...
                    name="peopleAmount"
                    onChange={(e) =>
                        setReservation((prev) => ({ ...prev, peopleAmount: Number(e.target.value) }))
                    }
                    required
                />
                ...
                <input
                    ...
                    onChange={(e) =>
                        setReservation((prev) => ({ ...prev, reservationDateTime: new Date(e.target.value) }))
                    }
                    required
                />
                ...
                <input
                    ...
                    onChange={(e) =>
                        setReservation((prev) => ({ ...prev, reservationLengthMinutes: Number(e.target.value) }))
                    }
                    required
                />
                ...
                <input
                    ...
                    name="childFriendly"
                    onChange={(e) =>
                        setReservation((prev) => ({ ...prev, childFriendly: e.target.checked }))}
                />
